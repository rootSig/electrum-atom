...
from electrum_atom.plugin import hook, DeviceMgr
from electrum_atom.util import PrintError, UserCancelled, bh2u
from electrum_atom.wallet import Wallet, Standard_Wallet
    ...
    def request_trezor_init_settings(self, wizard, method, model):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from electrum_atom.keystore import is_xprv
