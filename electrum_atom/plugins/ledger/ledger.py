...
from electrum_atom.bitcoin import TYPE_ADDRESS, int_to_hex, var_int
from electrum_atom.i18n import _
from electrum_atom.plugin import BasePlugin
from electrum_atom.keystore import Hardware_KeyStore
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Bitcoin Atom" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise Exception(_("Device not in Bitcoin Atom mode")) from e
                raise e
