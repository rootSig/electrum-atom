...
;Interface Settings
  ...
  !define MUI_ICON "c:\electrum_atom\icons\electrum-atom.ico"
...
Section
  ...
  File "c:\electrum_atom\icons\electrum-atom.ico"
  ...
  WriteRegStr HKCU "Software\Classes\bitcoinatom" "DefaultIcon" "$\"$INSTDIR\electrum-atom.ico, 0$\""
