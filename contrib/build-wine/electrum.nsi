...
;Variables
  ...
  !define PRODUCT_WEB_SITE "https://github.com/bitcoin-atom/electrum-atom"
...
;Interface Settings
  ...
  !define MUI_ICON "c:\electrum_atom\icons\electrum_atom.ico"
...
Section
  ...
  File "c:\electrum_atom\icons\electrum_atom.ico"
  ...
  WriteRegStr HKCU "Software\Classes\bitcoinatom" "DefaultIcon" "$\"$INSTDIR\electrum_atom.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\bitcoinatom\shell\open\command" "" "$\"$INSTDIR\electrum-atom-${PRODUCT_VERSION}.exe$\" $\"%1$\""
  ...
  WriteRegStr HKCU "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\electrum_atom.ico"
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\bitcoinatom"
