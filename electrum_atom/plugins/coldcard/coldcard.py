...
from electrum_atom.bitcoin import serialize_xpub, deserialize_xpub, InvalidMasterKeyVersionBytes
from electrum_atom import constants
from electrum_atom.bitcoin import TYPE_ADDRESS, int_to_hex
from electrum_atom.i18n import _
from electrum_atom.plugin import BasePlugin, Device
from electrum_atom.keystore import Hardware_KeyStore, xpubkey_to_pubkey, Xpub
from electrum_atom.transaction import Transaction
from electrum_atom.wallet import Standard_Wallet
from electrum_atom.crypto import hash_160
from ..hw_wallet import HW_PluginBase
from ..hw_wallet.plugin import is_any_tx_output_on_change_branch
from electrum_atom.util import print_error, bfh, bh2u, versiontuple
...
try:
    ...
    class ElectrumColdcardDevice(ColdcardDevice):
        ...
        def mitm_verify(self, sig, expect_xpub):
            ...
            from electrum_atom.ecc import ECPubkey
...
class Coldcard_KeyStore(Hardware_KeyStore):
    ...
    def _encode_txin_type(txin_type):
        # Map from electrum_atom code names to our code numbers.
