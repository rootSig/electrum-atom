...
from electrum_atom.util import base_units_list
...
from electrum_atom import coinchooser
...
class SettingsDialog(Factory.Popup):
    ...
    def proxy_dialog(self, item, dt):
        if self._proxy_dialog is None:
            ...
            popup = Builder.load_file('electrum_atom/gui/kivy/uix/ui_screens/proxy.kv')
